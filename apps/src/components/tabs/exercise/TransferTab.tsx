...
export default function TransferTab() {
  ...
  // hash: トランザクションハッシュ
  // reset: 状態リセット関数
  const { transfer, isReady, isLoading, isSuccess, error, hash, reset } =
    useTransfer();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            React SDKのuseTransferフックを使用した送信
          </p>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-soft p-6">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={
                  !isConnected || !isReady || isLoading || !recipient || !amount
                }
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span>isLoading:</span>
                <span
                  className={isLoading ? "text-orange-600" : "text-gray-600"}
                >
                  {isLoading ? "✓" : "✗"}
                </span>
              </div>
              <div className="flex justify-between">
                <span>isSuccess:</span>
                <span
                  className={isSuccess ? "text-green-600" : "text-gray-600"}
                >
                  {isSuccess ? "✓" : "✗"}
                </span>
              </div>
