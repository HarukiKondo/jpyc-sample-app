...
import { getGatewayAddress, createPermitSignature } from "@/lib/jpycClient";
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">
          EIP-2612 Permit機能を利用するには、ウォレットを接続してください。
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-3xl font-bold text-gray-900">
          ✍️ EIP-2612 Permit (学習版)
        </h2>
        <p className="text-gray-600 mt-2 text-lg">
          React SDKのusePermitフックを実装してガスレス許可設定してみよう
        </p>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {deadline &&
                    `${new Date(parseInt(deadline) * 1000).toLocaleString(
                      "ja-JP"
                    )}`}
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                ...
                <p className="text-sm text-blue-800">
                  EIP-712に基づく構造化データ署名です。 v, r, s
                  の3つの要素で構成され、楕円曲線署名の標準形式です。
                </p>
              </div>
