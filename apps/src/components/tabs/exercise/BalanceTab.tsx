      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2 text-lg">
            React SDKフックで自動更新される残高とTotal Supply
          </p>
        </div>
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          {isLoading && (
            <div className="flex items-center ml-4">
              <svg
                className="animate-spin w-4 h-4 text-blue-500 mr-2"
                fill="none"
                viewBox="0 0 24 24"
              >
                <circle
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-base text-blue-800 leading-relaxed">
                  ERC20の
                  <code className="bg-blue-200 px-2 py-1 rounded text-sm font-mono border">
                    balanceOf
                  </code>
                  関数を使用してJPYC残高を取得しています。
          ...
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
            <div className="flex items-start">
              ...
              <div>
                <h5 className="font-bold text-green-900 mb-2 text-lg">
                  Total Supply
                </h5>
                <p className="text-base text-green-800 leading-relaxed">
                  ERC20の
                  <code className="bg-green-200 px-2 py-1 rounded text-sm font-mono border">
                    totalSupply
                  </code>
                  関数を使用してJPYCの総供給量を取得しています。
