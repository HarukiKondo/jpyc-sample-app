...
export default function ApproveTab() {
  ...
  return (
    <div className="space-y-6">
      {/* ヘッダー */}
      <div>
        <h2 className="text-3xl font-bold text-gray-900">ERC20 Approve (React SDK)</h2>
        <p className="text-gray-600 mt-2 text-lg">React SDKのuseApproveフックでPayment Gatewayに承認</p>
      </div>
